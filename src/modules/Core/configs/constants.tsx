...
export const PRIORITY: Record<LevelType, string[]> = {
  ...
  3: ["bg-gray-600/70", "bg-gray-100", "text-gray-600/70", "Normal"],
  4: ["bg-blue-600/70", "bg-blue-100", "text-blue-600/70", "Low"],
  5: ["bg-green-600/70", "bg-green-100", "text-green-600/70", "Ground"],
};
